ad_page_contract {
    ...
    @cvs-id $Id: portrait.tcl,v 1.8.8.2 2013/11/27 07:39:12 gustafn Exp $
} {
    user_id:integer
} -properties {
    context:onevalue
...
if {![db_0or1row user_info "select first_names, last_name from persons where person_id=:user_id"]} {
