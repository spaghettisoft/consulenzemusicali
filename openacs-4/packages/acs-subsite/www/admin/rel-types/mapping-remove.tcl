...
ad_page_contract {
    ...
    @cvs-id $Id: mapping-remove.tcl,v 1.2.26.4 2013/09/09 16:44:23 gustafn Exp $
...
set context [list [list "" "Group types"] [list one?[export_vars {group_type}] "One type"] "Remove relation type"]
