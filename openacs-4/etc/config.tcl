...
set httpport [exec grep "^NS_PORT" /etc/naviserver/conf.d/${server}.sh | sed s/NS_PORT=//] 
set httpsport 443

set hostname localhost
set address  [exec grep "^NS_ADDRESS" /etc/naviserver/conf.d/${server}.sh | sed s/NS_ADDRESS=//]

set serverroot		"/var/lib/naviserver/${server}"
...
set max_file_upload_mb        1000
set max_file_upload_min        550
